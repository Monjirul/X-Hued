        ...
        <form action="{{route('home.updateUserInfo')}}" id="infoForm" method="post" style="width: 60%; margin-left: 20%;">
            ...
            <div class="row">
                ...
                <div class="col-12 mb-3">
                    ...
                    <input type="number" class="form-control" id="cNumber" name="number" min="0" value="{{$loggedUser->phone}}" required>
                </div>
            ...
            <tr>
                ...
                <td class="message" style="margin-left: 5%;">
                    ...
                    <table class="sTable" style="table-layout:fixed;">
                        ...
                        <tbody id="Table">
                        @foreach($messages as $message)
                        @if($message->mTo == $loggedUser->email)
                        <tr>
                            <td width="50%" class="limitText">{{$message->message}}</td>
    ...
    <div id="Previous_Products" class="tabcontent" >
        ...
        <table class="sTable">
            ...
            <tr>
                ...
                <td width="25%"><img src="/assets/img/{{$product->path}}"></td>
                <td width="20%">{{$product->addedDate}}</td>
