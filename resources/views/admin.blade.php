        ...
        <form action="{{route('home.updateUserInfo')}}" id="infoForm" method="post" style="width: 60%; margin-left: 20%;">
            ...
            <div class="row">
                ...
                <div class="col-12 mb-3">
                    ...
                    <input type="number" class="form-control" id="pNumber" name="number" min="0" value="{{$loggedUser->phone}}" required>
                </div>
    ...
    <div id="Order_List" class="tabcontent" >
        ...
        <table class="sTable">
            ...
            <tr>
                ...
                <td width="10%">
                    <a href="{{route('print.invoice', ['cartId' => $order->cartId, 'download' => false ])}}" target="_blank"><b style="color: green;" >View</b></a> | 
    ...
    <div id="Messages" class="tabcontent" >
        <table width="100%">
            <tr>
                <td class="message">
                    <h4>Compose</h4> 
                    <form action="{{route('message.send')}}" method="post" id="message_detail">
                        {{csrf_field()}}
                         <table>
                            <tr>
                                <td>To :<br><br></td>
                                <td>
                                    <input type="email" name="email" style="width: 270px;" id='autoSearch' placeholder="Get email by search" required><br><br>
                                </td>
                            </tr>
                            <tr>
                                <td>Message :<br><br><br><br><br></td>
                                <td>
                                    <textarea rows="4" cols="35" name="message" form="message_detail" required></textarea>
                                    <br><br>
                                </td>
                             </tr>
                            <tr>
                                <td colspan="2">
                                     <input type="submit" value="Send" class="btn essence-btn" style=" height: 50px;">
                                    <input type="reset" value="Reset"  class="btn essence-btn" style=" height: 50px;">
                                 </td>
                            </tr>
                        </table>
                     </form> 
                ...
                <td class="message">
                    ...
                    <table class="sTable" style="table-layout:fixed;">
                        ...
                        @if($message->mFrom == $loggedUser->email)
                        <tr>
                            <td width="50%" class="limitText">{{$message->message}}</td>
                            <td width="30%">{{$message->mTo}}</td>
                            <td width="10%" style="color: green;" onclick="alert('{{$message->message}}')">view</td>
                        </tr>
                        @endif
                        @endforeach
                        </tbody>
                ...
                <td class="message" style="margin-left: 5%;">
                    <h4>Inbox</h4>
                    <table class="sTable" style="table-layout:fixed;">
                        <tr>
                        ...
                        <tbody id="Table">
                        @foreach($messages as $message)
                        @if($message->mTo == 'admin')
                        <tr>
                            <td width="40%" class="limitText">{{$message->message}}</td>
                            <td width="30%">{{$message->mFrom}}</td>
                            <td width="10%" style="color: green;" onclick="alert('{{$message->message}}')">view</td>
                        </tr>
                        @endif
                        @endforeach
