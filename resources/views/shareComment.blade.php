       ...
       <!--     <span>{{$product['tag']}}</span>
            ...
            <!-- Form -->               
                    ...
                    <table class="sTable" style="table-layout:fixed;">
                        ...
                        <tr>
                            <td width="50%" class="limitText">{{$comment->comment}}</td>
                            <td width="30%">{{$comment->cId}}</td>
                            <td width="10%" style="color: green;" onclick="alert('{{$comment->comment}}')">view</td>
                        </tr>
            ...
            <form class="form" method="post" action="{{route('shareController.commentToShare')}}"> 
                {{csrf_field()}}
              ...
              <br>
                ...
                <input type="submit" name="sellProduct" class="btn essence-btn" value="SHARE"/>
            </form>
        </div>
    </section>
