                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <div class="single-product-wrapper">
                                    ...
                                    <div class="product-description">
                                      ...
                                      @foreach($likedProducts as $lp)

                                           @if($product->id==$lp->id)
                                           

                                   <p id="likeCount">Likes : {{$lp->totalLikes}}</p>
                                      ...
                                      <button id="{{$product->id}}" value="like" onclick="getMessage('{{$product->id}}')">LIKE</button>
                                        ...
                                        <div class="hover-content">
                                            ...
                                            <div class="add-to-cart-btn">
                                                <a href="{{route('shareComment', ['id' => $product->id])}}" class="btn essence-btn">View </a>
                                            </div>
                                        </div>
...
var decision='0';
if(document.getElementById(x).innerHTML=="LIKE")
{
decision='1';
}
else{
 ...
 // alert(decision);
  ...
  headers: {
    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
          ...
          //var pId=document.getElementById('x').innerHTML;
           // alert(x);
            $.ajax({
               type:'POST',
               url:'/getmsg',
               data:{'pId': x,'dis': decision},
