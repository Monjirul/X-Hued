...
function GoToSell(){
document.getElementById("SellCanvas").value=document.getElementById("c").toDataURL();
document.getElementById("SellPrice").value=price;

document.getElementById("addSxProduct").submit();
}

function GoToShare(){
document.getElementById("shareCanvas").value=document.getElementById("c").toDataURL();
document.getElementById("sharePrice").value=price;

document.getElementById("sharexProduct").submit();
}
